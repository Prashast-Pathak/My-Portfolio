...
const skills = [
  { icon: <Database className="w-8 h-8" />, title: "SQL", score: 85, description: "Query architect" },
  { icon: <BarChart3 className="w-8 h-8" />, title: "Power BI", score: 80, description: "Visual storyteller" },
  { icon: <FileSpreadsheet className="w-8 h-8" />, title: "Excel", score: 75, description: "Data sculptor" },
  { icon: <Code className="w-8 h-8" />, title: "Python", score: 70, description: "Logic weaver" },
  { icon: <Sigma className="w-8 h-8" />, title: "Statistics", score: 70, description: "Pattern seeker" },
];
...
const CinematicAbout = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute top-1/4 left-1/4 w-64 h-64 rounded-full bg-gradient-to-r from-primary/20 to-transparent filter blur-3xl"
      ...
      />
      <motion.div
        className="absolute bottom-1/3 right-1/3 w-48 h-48 rounded-full bg-gradient-to-l from-accent/15 to-transparent filter blur-2xl"
      ...
      <motion.div
        className="relative z-10 min-h-screen flex flex-col justify-center px-6 py-20"
      ...
      >
        ...
        >
          ...
          <motion.p
            className="text-2xl md:text-3xl text-gray-300 font-light font-['Plus_Jakarta_Sans'] leading-relaxed max-w-4xl mx-auto"
        ...
        >
          <motion.h2
            className="text-5xl md:text-6xl font-extrabold text-center mb-20 font-['Plus_Jakarta_Sans']"
            style={{
    ...
    >
      ...
      <div className="flex-1 space-y-6">
        <div className="flex items-center gap-4 mb-6">
          <motion.div
            className="text-6xl font-bold text-primary/30 font-mono"
            whileHover={{ scale: 1.1, color: "#A8FF60" }}
          >
            {number}
          </motion.div>
          <div>
            <h3 className="text-3xl md:text-4xl font-bold text-white font-['Plus_Jakarta_Sans'] mb-2">
              {title}
            </h3>
        ...
        <motion.p
          className="text-xl text-gray-200 leading-relaxed font-['Plus_Jakarta_Sans'] mb-6"
        ...
        <motion.p
          className="text-gray-400 leading-relaxed font-['Plus_Jakarta_Sans']"
          initial={{ opacity: 0, y: 20 }}
          animate={isInView ? { opacity: 1, y: 0 } : {}}
      ...
      >
        <motion.div
          className="relative w-80 h-80 rounded-full bg-gradient-to-br from-primary/20 via-transparent to-accent/20 backdrop-blur-xl border border-primary/30 flex items-center justify-center group cursor-pointer"
          whileHover={{
            scale: 1.05,
          ...
          {[...Array(8)].map((_, i) => (
            <motion.div
              ...
              style={{
                top: "50%",
                left: "50%",
                transformOrigin: `${Math.cos(i * 45 * Math.PI / 180) * 120}px ${Math.sin(i * 45 * Math.PI / 180) * 120}px`,
              }}
              animate={{
                rotate: [0, 360],
                scale: [1, 1.5, 1],
...
const SkillOrb = ({ skill, index }: { skill: any; index: number }) => {
  ...
  return (
    ...
    >
      {/* Skill Card */}
      <div className="relative p-8 rounded-3xl bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-xl border border-primary/30 overflow-hidden">
        {/* Animated background */}
        <motion.div
        ...
        {/* Icon */}
        <motion.div
          className="relative w-16 h-16 mx-auto mb-6 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center text-black shadow-lg"
          animate={{ 
            rotate: [0, 360],
            boxShadow: [
        ...
        <div className="text-center mb-6">
          <h3 className="text-2xl font-bold text-white mb-2 font-['Plus_Jakarta_Sans']">
            {skill.title}
          </h3>
